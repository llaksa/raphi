...
\item[-] Analizar los valores medidos para hallar datos ue optimicen el cultivo vertical.
...
\chapter{Metodología}
\section{Hipótesis}
Mediante el monitoreo, control y registro de ciertos parámetros ambientales de
un cultivo vertical se podrá utilizar las técnicas A, B, C de machine learning para
optimizar la producción del mismo.
\section{Variables}
