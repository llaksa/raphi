...
...
...
En este trabajo se presenta la integración de un módulo de software, compuesto
de un sistema web de Internet de las Cosas a modo de SCADA con características
de visión artificial, y un prototipo de computadora alimentaria personal. Con el
propósito de aplicar métodos que permitan optimizar los parámetros climáticos
utilizados en sistemas de agricultura de ambiente controlado.
...
...
...
\section{Abstract}
...
\item[-] Algoritmos de visión artificial
\end{enumerate}
...
\item[-] Población:
  ...
  Algoritmos de aprendizaje de máquina y control moderno
\item[-] Muestra:
